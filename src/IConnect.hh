...
/** Textual name of the interface that components who want to 
    be connected to others via the 'connect' command, must implement */
#define ICONNECT_ID "ab81cb7a-88de-4afd-b980-1334dc98dd5e"

/** Interface of the Config client */
class IConnect  : public IBase
{
  public:
    /** Constructor */
    IConnect() : IBase("IConnect", ICONNECT_ID) { }

    /** Connect function pointer */
    virtual int connect(CFComponent *other, char *iface,
						int argc, char **argv) = 0;
    /** Disconnect function pointer */
    virtual int disconnect(CFComponent *other, char *iface) = 0;
};
